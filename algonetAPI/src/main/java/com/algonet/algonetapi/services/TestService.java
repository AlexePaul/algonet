...
public class TestService {
    ...
    private final EntityManager entityManager;    @CheckOwn(entity = Problem.class)
    public Test create(Integer userId, Integer problem_id, TestCreationDTO testCreationDTO) {
        Test test = new Test();
    ...
    public Test get(Integer userId, Integer id) {
        return testRepository.findById(id).orElseThrow(NotFoundException::new);
    }
    
    @CheckOwn(entity = Test.class)
    public Test update(Integer userId, Integer id, TestCreationDTO testCreationDTO) {
    ...
    public List<Test> getAll(Integer userId, Integer problem_id) {
